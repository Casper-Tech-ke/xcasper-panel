    ...
    public function boot(): void
    {
        ...
        $this->routes(function () {
            Route::middleware('web')->group(function () {
                ...
                Route::post('/super-admin', [SuperAdminController::class, 'save']);
                Route::post('/super-admin/unlock', [SuperAdminController::class, 'unlock']);
                Route::post('/super-admin/lock', [SuperAdminController::class, 'lock']);
                Route::post('/super-admin/email', [SuperAdminController::class, 'saveEmail']);
                Route::post('/super-admin/billing', [SuperAdminController::class, 'saveBilling']);
                Route::get('/super-admin/revenue', [SuperAdminController::class, 'revenue']);
                Route::post('/super-admin/users/ban', [SuperAdminController::class, 'banUser']);
