...
Route::prefix('/billing')->group(function () {
    Route::get('/',                        [Client\BillingController::class, 'status']);
    Route::post('/initialize',             [Client\BillingController::class, 'initialize']);
    Route::post('/verify',                 [Client\BillingController::class, 'verify']);
    Route::post('/recharge/initialize',    [Client\BillingController::class, 'rechargeInitialize']);
    Route::post('/recharge/verify',        [Client\BillingController::class, 'rechargeVerify']);
    Route::post('/push/subscribe',         [Client\BillingController::class, 'pushSubscribe']);
    Route::post('/push/unsubscribe',       [Client\BillingController::class, 'pushUnsubscribe']);
    Route::get('/transactions',            [Client\BillingController::class, 'transactions']);
    Route::get('/my-servers',              [Client\BillingController::class, 'myServers']);
    Route::post('/server/initialize',      [Client\BillingController::class, 'serverInitialize']);
    Route::post('/server/verify',          [Client\BillingController::class, 'serverVerify']);
});
...
Route::group([
    ...
    Route::group(['prefix' => '/files'], function () {
        ...
        Route::post('/git-clone', [Client\Servers\GitCloneController::class, 'clone']);
    });
